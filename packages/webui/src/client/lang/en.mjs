const en = {
	...
	sync: {
		title: "Sync",
		subtitle: "Automatically sync your Deezer favorites to local downloads",
		settings: {
			title: "Settings",
			enableSync: "Enable Sync",
			enableSyncHelp: "Automatically sync your Deezer favorites to downloads",
			interval: "Sync Interval (minutes)",
			intervalHelp: "Minimum 5 minutes between sync runs",
			batchSize: "Batch Size",
			batchSizeHelp: "Number of concurrent downloads per batch (1-100)",
		...
		toasts: {
			...
			intervalTooShort: "Interval must be at least 5 minutes",
